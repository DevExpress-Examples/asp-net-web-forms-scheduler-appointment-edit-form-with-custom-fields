...
'INSTANT VB NOTE: The field amount was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private amount_Conflict As Double
'INSTANT VB NOTE: The field memo was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private memo_Conflict As String
	...
	Public Property Amount() As Double
		...
		Set(ByVal value As Double)
			amount_Conflict = value
		End Set
	End Property
	Public Property Memo() As String
		Get
			Return memo_Conflict
		End Get
		Set(ByVal value As String)
			memo_Conflict = value
		End Set
