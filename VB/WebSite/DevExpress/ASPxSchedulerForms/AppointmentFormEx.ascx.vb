...
'INSTANT VB NOTE: The field recurrenceControl was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private recurrenceControl_Conflict As AppointmentRecurrenceControl
	...
	Public ReadOnly Property RecurrenceControl() As AppointmentRecurrenceControl
		Get
			Return recurrenceControl_Conflict
		End Get
	End Property
	...
	Protected Sub RenderRecurrenceControl(ByVal isRecurring As Boolean)
		If Me.recurrenceControl_Conflict IsNot Nothing Then
			Me.recurrenceControl_Conflict.Visible = isRecurring
			Return
		End If
		Dim container As AppointmentFormTemplateContainer = CType(Parent, AppointmentFormTemplateContainer)
		Me.recurrenceControl_Conflict = New AppointmentRecurrenceControl()
		recurrenceControl_Conflict.ID = "RecurrenceControl1"
		recurrenceControl_Conflict.Visible = isRecurring 'container.ShouldShowRecurrence;
		recurrenceControl_Conflict.DayNumber = container.RecurrenceDayNumber
		recurrenceControl_Conflict.End = container.RecurrenceEnd
		recurrenceControl_Conflict.Month = container.RecurrenceMonth
		recurrenceControl_Conflict.OccurrenceCount = container.RecurrenceOccurrenceCount
		recurrenceControl_Conflict.Periodicity = container.RecurrencePeriodicity
		recurrenceControl_Conflict.RecurrenceRange = container.RecurrenceRange
		recurrenceControl_Conflict.Start = container.RecurrenceStart
		recurrenceControl_Conflict.WeekDays = container.RecurrenceWeekDays
		recurrenceControl_Conflict.WeekOfMonth = container.RecurrenceWeekOfMonth
		recurrenceControl_Conflict.RecurrenceType = container.RecurrenceType
		recurrenceControl_Conflict.IsFormRecreated = container.IsFormRecreated
		RecurrencePanel.Controls.Add(recurrenceControl_Conflict)
		recurrenceControl_Conflict.EditorsInfo = New EditorsInfo(container.Control, container.Control.Styles.FormEditors, container.Control.Images.FormEditors, container.Control.Styles.Buttons)
	End Sub
End Class
