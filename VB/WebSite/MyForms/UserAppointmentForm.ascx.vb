...
Partial Public Class UserAppointmentForm
	...
	Protected Overrides Function GetChildEditors() As ASPxEditBase()
		...
		Dim edits() As ASPxEditBase = { lblSubject, tbSubject, lblLocation, tbLocation, lblLabel, edtLabel, lblStartDate, edtStartDate, lblEndDate, edtEndDate, lblStatus, edtStatus, lblAllDay, chkAllDay, lblResource, edtResource, tbDescription, cbReminder, ddResource, tbField1, memField2 }
		Return edits
	End Function
